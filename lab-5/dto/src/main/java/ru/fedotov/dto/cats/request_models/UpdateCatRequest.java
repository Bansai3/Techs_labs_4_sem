...
public class UpdateCatRequest {
    ...
    @Positive(message = "Cat id must be >= 1!")
    private Long id;
    ...
    public @Positive(message = "Cat id must be >= 1!") Long getId() {
        return this.id;
    }
    ...
    public void setId(@Positive(message = "Cat id must be >= 1!") Long id) {
        this.id = id;
    }

    public boolean equals(final Object o) {
        if (o == this) return true;
        if (!(o instanceof UpdateCatRequest)) return false;
        final UpdateCatRequest other = (UpdateCatRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UpdateCatRequest;
    }
