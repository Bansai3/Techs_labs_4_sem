...
public class CreateCatDto {
    ...
    public CreateCatDto(@NotEmpty @JsonProperty("name") String name,
                        @NotEmpty @JsonProperty("birthdayDate") LocalDate birthdayDate,
                        @NotEmpty @JsonProperty("breed") String breed,
                        @NotEmpty @JsonProperty("colour") String colour) {
        this.name = name;
