...
public class CreateCatDto {
    ...
    public CreateCatDto(
        ...
        this.breed = breed;
        CatColour catColour = CatColour.valueOf(colour);
        this.colour = catColour.name();
    }
    ...
    public String toString() {
        return "CreateCat(name=" + this.getName() + ", birthdayDate=" + this.getBirthdayDate() + ", breed=" + this.getBreed() + ", colour=" + this.getColour() + ")";
    }
}
